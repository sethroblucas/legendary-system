...
// AETHON palette — further desaturated, quieter
const COLOR_SATELLITE = new THREE.Color('#7ab3be');
const COLOR_DEBRIS = new THREE.Color('#b0766a');
const COLOR_STATION = new THREE.Color('#c4bfb2');
